...
public class ControladorCompras {
    ...
    public static void pintar(VentanaInicio ventanaInicio, Integer serialCompra) {
        ...
        ventanaInicio.getLabelTexto()[3].setText(labelCompra[1]);
        ventanaInicio.getContenedorTexto()[3].add(ventanaInicio.getFieldFechaCompra());
        ...
        ventanaInicio.getLabelTexto()[2].setText(labelCompra[3]);
        ventanaInicio.getContenedorTexto()[2].add(ventanaInicio.getFieldNombreProveedorCompra());
